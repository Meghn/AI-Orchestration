...
from llama_index.core import (
    Settings, load_index_from_storage # set_global_service_context
)
...
def main():
    ...
    if os.path.exists(args.persist_dir):
        ...
        # Reding the document using SimpleDirectoryReader
    ...
    # Create a chat engine from the retriever and query engine
    ...
    chat_engine.chat_repl() # repl = read, eval, print, loop
